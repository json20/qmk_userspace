...
[_QWERTY] = LAYOUT(
  ...
  KC_LCTL,  KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                                    KC_H,    KC_J,       KC_K,    KC_L,    KC_BSLS, KC_QUOT,
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,      MO(_RAISE),   MO(_SYMBOLS),   KC_N,    KC_M,       KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                             KC_LALT, KC_LGUI, KC_BSPC,   KC_ENT,       KC_SPC,         KC_SCLN, MO(_LOWER), KC_RGUI
),
